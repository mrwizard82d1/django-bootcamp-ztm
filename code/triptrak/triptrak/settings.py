"""
Django settings for triptrak project.
...
SECRET_KEY = 'django-insecure-s@)#6k*=if$n7q6&$e%@szo9hq#3h^b=0k&-bql)281#%70)m%'
...
WSGI_APPLICATION = 'triptrak.wsgi.application'
